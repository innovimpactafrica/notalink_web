    ...
    <app-main-layout pageTitle="Paiements">
      <div class="mx-auto">
        ...
        <div>
          ...
          <!-- Tab Content -->
          <div class="py-6">
            <app-invoices-tab *ngIf="activeTab === 0"></app-invoices-tab>
            <app-payment-receipts-tab *ngIf="activeTab === 1"></app-payment-receipts-tab>
            <app-financial-reports-tab *ngIf="activeTab === 2"></app-financial-reports-tab>
          </div>
        </div>
      </div>
    </app-main-layout>
